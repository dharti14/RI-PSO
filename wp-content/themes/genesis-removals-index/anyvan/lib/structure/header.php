...
add_action('genesis_header', 'anyvan_header');
function anyvan_header(){
  ...
  <header class="main">
    <section id="logo_call">
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <a id="logo" href="<?php if ( is_page_template('anyvan/anyvan.php')) {
              ...
              <img width="180" src="<?php echo THEME_PATH_URI;?>/anyvan/lib/assets/images/removals-index_logo.svg" alt="<?php echo $dki_hln;?>"/>
            </a>
          </div>
          <div class="col-sm-4">
          	<div class="trustpilot-logos">
          		<img src="<?php echo THEME_PATH_URI;?>/anyvan/lib/assets/images/Trustpilot.svg" alt="<?php echo $dki_hln;?>"/>
          	</div>
          </div>
