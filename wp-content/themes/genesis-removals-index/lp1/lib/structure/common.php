...
function lp1_load_scripts() {
	...
	wp_enqueue_script('lp1_customizer', TDU.'/lp1/lib/assets/js/customizer.js' );
	wp_enqueue_script('lp1_bootstrapjs', TDU.'/lp1/lib/assets/js/bootstrap.min.js' );
	wp_enqueue_script('trustpilot', '//widget.trustpilot.com/bootstrap/v5/tp.widget.bootstrap.min.js', '', '', true);

	// LOAD MAIN STYLE
	wp_enqueue_style('lp1_bootstrapcss', TDU.'/lp1/lib/assets/css/bootstrap.min.css');
	wp_enqueue_style('lp1_style_css', TDU.'/lp1/lib/assets/css/style.css');
	wp_enqueue_style('lp1_fontawsome', TDU.'/lp1/lib/assets/css/font-awesome.min.css');
