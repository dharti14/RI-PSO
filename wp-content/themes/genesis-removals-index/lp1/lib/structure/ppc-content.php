									...
									<div class="checkbox align_center">
										<div class="row">
											<label class="col-sm-4">
												<input type="radio" checked name="h_type"/> Residential
											</label>
											<label class="col-sm-4">
												<input type="radio" name="h_type"/> Commercial
											</label>
											<label class="col-sm-4">
												<input type="radio" name="h_type"/> International
											</label>
										</div>
									</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<div class="wrap">
						<figure class="cell">
							<img src="<?php echo TDU;?>/lp1/lib/assets/images/client-img.png" alt="Tom Deller, London"/>
						</figure>
				...
				<div class="col-sm-4">
					<div class="wrap">
						<figure class="cell">
							<img src="<?php echo TDU;?>/lp1/lib/assets/images/client-img2.png" alt="Christine Key, Manchester"/>
						</figure>
						<div class="cell testimonial">
				...
				<div class="col-sm-4">
					<div class="wrap">
						<figure class="cell">
							<img src="<?php echo TDU;?>/lp1/lib/assets/images/client-img3.png" alt="Adam Kirkpatrick, Brighton"/>
						</figure>
						<div class="cell testimonial">
	...
	<section id="find_out_more">
		<div class="container">
			...
			<div class="foot_imgs">
				<div class="row">
					<div class="col-sm-4">
						<img src="<?php echo TDU;?>/lp1/lib/assets/images/footer-img1.png" alt="Hacker Safe"/>
					</div>
					<div class="col-sm-4">
						<img src="<?php echo TDU;?>/lp1/lib/assets/images/footer-img2.png" alt="SSL"/>
					</div>
					<div class="col-sm-4">
						<img src="<?php echo TDU;?>/lp1/lib/assets/images/footer-img3.png" alt="SSL Secure Connection"/>
					</div>
				</div>
			</div>
