...
add_action('genesis_header', 'lp4_header');
function lp4_header(){
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="header-logo-wrapper">
	            <a id="logo" href="<?php if ( is_page_template('lp4/lp4-ppc.php')) {
	              ...
	              <img width="180" src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/removals-index_logo.svg" alt="<?php echo $dki_hln;?>"/>
	            </a>
            </div>
          </div>
          <div class="col-sm-4">
           <div class="header-trustpilot-logos-wrapper">
          	<div class="trustpilot-logos">
          		<img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/Trustpilot.svg" alt="<?php echo $dki_hln;?>"/>
          	</div>
           </div>	
          </div>
