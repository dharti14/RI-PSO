...
<div id="dki">
	...
	<section id="testimonials">
		...
		<span class="arrow-post"><img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/arrow.png" alt="<?php echo $dki_hln;?>"></span>
			<div class="row">
				<div class="col-sm-4">
					<div class="wrap">
						<figure class="cell">
							<img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/client-img.png" alt="Tom Deller, London"/>
						</figure>
				...
				<div class="col-sm-4">
					<div class="wrap">
						<figure class="cell">
							<img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/client-img2.png" alt="Christine Key, Manchester"/>
						</figure>
						<div class="cell testimonial">
				...
				<div class="col-sm-4">
					<div class="wrap">
						<figure class="cell">
							<img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/client-img3.png" alt="Adam Kirkpatrick, Brighton"/>
						</figure>
						<div class="cell testimonial">
	...
	<section id="find_out_more">
		<div class="container">
		<span class="arrow-post1"><img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/arrow.png" alt="<?php echo $dki_hln;?>"></span>
			...
			<div class="foot_imgs">
				<div class="row">
					<div class="col-sm-4 footer-images">
						<img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/footer-img1.png" alt="Hacker Safe"/>
					</div>
					<div class="col-sm-4 footer-images">
						<img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/footer-img2.png" alt="SSL"/>
					</div>
					<div class="col-sm-4 footer-images">
						<img src="<?php echo THEME_PATH_URI;?>/lp4/lib/assets/images/footer-img3.png" alt="SSL Secure Connection"/>
					</div>
				</div>
			</div>
