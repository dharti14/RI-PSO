...
add_action('wp_enqueue_scripts', 'lp4_load_scripts');
function lp4_load_scripts() {
	...
	// Enqueuing Scripts and Styles for lp4
	wp_enqueue_script('jquery');
	wp_enqueue_script('lp4_customizer', THEME_PATH_URI.'/lp4/lib/assets/js/customizer.js',array('jquery'),'',true );
	wp_enqueue_script('lp4_bootstrapjs', THEME_PATH_URI.'/lp4/lib/assets/js/bootstrap.min.js',array('jquery'),'',true );
	

	// LOAD MAIN STYLE
	wp_enqueue_style('lp4_bootstrapcss', THEME_PATH_URI.'/lp4/lib/assets/css/bootstrap.min.css');
	wp_enqueue_style('lp4_style_css', THEME_PATH_URI.'/lp4/lib/assets/css/style.css');
	wp_enqueue_style('lp4_fontawsome', THEME_PATH_URI.'/lp4/lib/assets/css/font-awesome.min.css');
