...
add_action('wp_enqueue_scripts', 'lp3_load_scripts');
function lp3_load_scripts() {
	...
	// LOAD MAIN STYLE
	wp_enqueue_style('lp3_bootstrapcss', THEME_PATH_URI.'/lp3/lib/assets/css/bootstrap.min.css');
	wp_enqueue_style('lp3_style_css', THEME_PATH_URI.'/lp3/lib/assets/css/style.css');
	wp_enqueue_style('lp3_fontawsome', THEME_PATH_URI.'/lp3/lib/assets/css/font-awesome.min.css');
