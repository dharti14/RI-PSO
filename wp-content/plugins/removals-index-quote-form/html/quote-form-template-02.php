          ...
          <div class="removing-stress-frm-con">
              ...
              <div class="form-group">
               ...
               <textarea style="display:none;" id="greenwood_drive1" placeholder="Enter any additional information about your move.." name="additional_info"></textarea>
				...
				<!--
        <button type="submit" id="button"><div class="btn btn-quote get-my-quote-second-business">YES! GET MY FREE QUOTES <span>100% Safe &amp; Secure Quote Delivery Process</span></div></button>
			-->
          ...
          <div class="removing-stress-frm-con">
              ...
              <div class="form-group">
               ...
               <textarea id="greenwood_drive2" style="display:none;" placeholder="Enter any additional information about your move ..." name="additional_info"></textarea>
				...
				<!--
       <button type="submit" id="button"><div class="btn btn-quote get-my-quote-second-international">YES! GET MY FREE QUOTES <span>100% Safe &amp; Secure Quote Delivery Process</span></div></button>
		 -->
