...
<title>Removals Index Companies quotes for UK Removals, International Removals and Office Moves</title>
...
<header class="header">
	<div class="container">
	  ...
	  <div class="row">
	    <div class="col-sm-6">
	     <div class="logo"><a href="/ri/main"><img src="images/logo.svg" alt="<?php echo $hln;?>"></a></div>
	     <div class="mobile-logo"><a href="/ri/main/"><img src="images/logo.svg" alt="<?php echo $hln;?>"></a></div>
	    </div>
	    <div class="col-sm-6">
	     <div class="contact-num">Call <strong>FREE</strong> on: <span class="number">0203 514 9040</span></div>
	    </div>
	  </div>
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/966350786/?label=srw-CNKE6G0Qwq_lzAM&amp;guid=ON&amp;script=0"/>
        ...
        <!-- bing conversion code begin -->
		<!--
        <script type="text/javascript"> if (!window.mstag) mstag = {loadTag : function(){},time : (new Date()).getTime()};</script>
        <script id="mstag_tops" type="text/javascript" src="//flex.atdmt.com/mstag/site/b8263766-a407-4f29-acfd-fe3a79d0049d/mstag.js"></script>
        <script type="text/javascript"> mstag.loadTag("analytics", {dedup:"1",domainId:"920135",type:"1",actionid:"96544"})</script>
        <noscript>
        <iframe src="//flex.atdmt.com/mstag/tag/b8263766-a407-4f29-acfd-fe3a79d0049d/analytics.html?dedup=1&domainId=920135&type=1&actionid=96544" frameborder="0" scrolling="no" width="1" height="1" style="visibility:hidden;display:none"> </iframe>
        </noscript>
		-->
        <!-- bing conversion code end -->	
...
<div class="thank-blog">
   ...
   <div class="row">
     ...
     <div class="col-sm-6">
      <div class="thank-you-top-img"><img src="images/thanks/people-boxes.jpg" alt=""></div>
     </div>
  ...
  <div class="row">
     <div class="col-sm-8">
		...
		{  
			...
			//end code for add name in "thank you" heading
			html = '<table cellpadding="5" cellspacing="0"><tbody>';
				for(x in data)
				{
					html += '<tr ><td style="border-bottom:1px solid #eee;">'+ data[x].label +'</td><td style="border-bottom:1px solid #eee;">'+ data[x].value +'</td></tr>';
				}
			html += '</tbody></table>';
			document.getElementById(elementId).innerHTML = html;
		}
		var ploc_key = "c6c2f463db4cb59a6e8bd62783a9f063";
		var domain = ((document.location.hostname == "localhost")?"localhost:133":"www.pinlocal.com");        
