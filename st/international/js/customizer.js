...
$( document ).ready(function() {
	...
	$(".get-my-quote").click(function(){ 
		...
		var dataString = 'postcode_from='+ postcode_from;
		...
		$.ajax({
			...
			success: function(result){
				...
				$("select[name='countryTo']").find("option[value='" + country_to + "']").attr("selected",true);
				if(country_to != ''){
	...
	$(".get-my-quote2").click(function(){ 
		...
		var country_to = $("#country_to2").val();
		var dataString = 'postcode_from='+ postcode_from;
		// AJAX Code To Submit Form.
		$("#show-after-get-international").css("display","block");
		$('html, body').animate({
	...
	$(".get-my-quote3").click(function(){ 
		...
		var country_to = $("#country_to3").val();
		var dataString = 'postcode_from='+ postcode_from;
		// AJAX Code To Submit Form.
		$("#show-after-get-international").css("display","block");
		$('html, body').animate({
