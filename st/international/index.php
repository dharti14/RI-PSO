       ...
       <div class="removing-stress-frm step4">
		...
		<div class="pp-info-wraper"> 	
			     <div class="form-group gdpr-info-wrapper">
				   ...
				   <div class="gdpr-opt-in-label"><label for="GDPR_opt_in_international">By clicking 'Yes, Get My Free Quotes' I agree to the <a href="/terms-and-conditions/" target="_blank"> terms and conditions </a> and <a href="/removals-index-privacy-policy-v2/" target="_blank">privacy policy</a>.</label></div>	
				</div>									 
			 	<div class="form-group">
