        ...
        <div class="get-my"><a class="get-my-quote-second-business">YES! GET MY FREE QUOTES <span>100% Safe &amp; Secure Quote Delivery Process</span></a></div>
        	...
        	<div class="pp-info-wraper"> 	
			     <div class="form-group gdpr-info-wrapper">
				   ...
				   <div class="gdpr-opt-in-label"><label for="GDPR_opt_in_commercial">By clicking 'Yes, Get My Free Quotes' I agree to the <a href="/terms-and-conditions/" target="_blank"> terms and conditions </a> and <a href="/removals-index-privacy-policy/" target="_blank">privacy policy</a>.</label></div>	
				</div>									 
			 	<div class="form-group">
