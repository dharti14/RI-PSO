...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
     <div class="contact-num"><label>Specialist Business Removers:</label>Call <strong>FREE</strong> on: <span class="number">0203 514 9040</span></div>
    </div>
  </div>
        ...
        <div class="get-my"><a class="get-my-quote-second-business">YES! GET MY FREE QUOTES <span>100% Safe &amp; Secure Quote Delivery Process</span></a></div>
        	...
        	<div class="pp-info-wraper"> 	
			     <div class="form-group gdpr-info-wrapper">
				   ...
				   <div class="gdpr-opt-in-label"><label for="GDPR_opt_in_commercial">By clicking 'Yes, Get My Free Quotes' I agree to the <a href="/terms-and-conditions/" target="_blank"> terms and conditions </a> and <a href="/removals-index-privacy-policy-v2/" target="_blank">privacy policy</a>.</label></div>	
				</div>									 
			 	<div class="form-group">
