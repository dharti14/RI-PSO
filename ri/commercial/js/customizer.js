	...
	$("#form input[name='phone']").keypress(phoneValidation);
        ...
        $("#form").validate({
                ...
                messages: {
					...
					packing_service: "Do you require a packing service?",
                    dismantle: "Do you require dismantle / reassemble service?",
					storage: "Do you require storage?",
	...
	//form-business validation rules
		...
		$("#form-business select[name='floor_from']").change(function(){
			if($(this).val() == "Ground"){ 
				...
				$(".leftpart .redio-with-text2 span").remove();
				$(".leftpart .redio-with-text2").append('<span class="vaild-check"><img src="images/input-check.png" alt=""></span>');
			}
			if($(this).val() != ""){
		...
		$("#form-business select[name='floor_to']").change(function(){
			if($(this).val() == "Ground"){ 
				...
				$(".rightpart .redio-with-text2 span").remove();
				$(".rightpart .redio-with-text2").append('<span class="vaild-check"><img src="images/input-check.png" alt=""></span>');
			}
			if($(this).val() != ""){
